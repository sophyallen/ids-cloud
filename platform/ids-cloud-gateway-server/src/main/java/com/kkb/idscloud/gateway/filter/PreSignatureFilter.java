package com.kkb.idscloud.gateway.filter;
...
import com.kkb.idscloud.common.utils.SignatureUtils;
...
public class PreSignatureFilter implements WebFilter {
    ...
    public PreSignatureFilter(BaseAppApi baseAppApi, ApiProperties apiProperties, JsonSignatureDeniedHandler signatureDeniedHandler) {
        this.apiProperties = apiProperties;
        this.baseAppApi = baseAppApi;
        ...
        if (apiProperties.getCheckSign() && !notSign(requestPath)) {
            try {
                ...
                if (baseAppApi != null) {
                    ...
                    // 获取客户端信息
                    ResultBody<BaseApp> result = baseAppApi.getApp(appId);
