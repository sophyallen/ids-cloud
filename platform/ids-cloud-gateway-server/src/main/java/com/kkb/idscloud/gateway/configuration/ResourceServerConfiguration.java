package com.kkb.idscloud.gateway.configuration;

import com.kkb.idscloud.base.api.BaseAppApi;
import com.kkb.idscloud.gateway.filter.*;
import com.kkb.idscloud.gateway.exception.JsonAccessDeniedHandler;
import com.kkb.idscloud.gateway.exception.JsonAuthenticationEntryPoint;
import com.kkb.idscloud.gateway.exception.JsonSignatureDeniedHandler;
import com.kkb.idscloud.gateway.oauth2.RedisAuthenticationManager;
...
public class ResourceServerConfiguration {
    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http) throws Exception {
        ...
        http
                ...
                // 签名验证过滤器
                .addFilterAt(new PreSignatureFilter(baseAppApi,apiProperties, new JsonSignatureDeniedHandler(accessLogService)), SecurityWebFiltersOrder.CSRF)
                // 访问验证前置过滤器
