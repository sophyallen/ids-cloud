package com.kaikeba.idscloud.flux.filter;

import com.kaikeba.idscloud.flux.filter.context.GatewayContext;
import com.kaikeba.idscloud.flux.filter.support.CachedBodyOutputMessage;
    ...
    private Mono<Void> readFormData(ServerWebExchange exchange,WebFilterChain chain,GatewayContext gatewayContext){
        ...
        return exchange.getFormData()
                ...
                .then(Mono.defer(() -> {
                    ...
                    return bodyInserter.insert(cachedBodyOutputMessage, new BodyInserter.Context() {
                ...
                .flatMap(dataBuffer -> {
                    ...
                    return ServerRequest.create(mutatedExchange, MESSAGE_READERS)
                            ...
                            .doOnNext(objectValue -> {
                                ...
                                try {
                                    gatewayContext.getAllRequestData().set("requestBody", objectValue);
                                }catch (Exception e){
