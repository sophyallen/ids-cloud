...
import com.kaikeba.idscloud.common.core.utils.EncodeUtils;
import com.kaikeba.idscloud.common.core.utils.IdsStringUtils;
...
public class WebUtils {
     ...
     * 静态文件后缀
     */
    private final static String[] staticFiles = IdsStringUtils.split(staticSuffix, ",");
    ...
    public static boolean isStaticFile(String uri) {
        return IdsStringUtils.endsWithAny(uri, staticFiles) && !IdsStringUtils.endsWithAny(uri, new String[]{urlSuffix})
                && !IdsStringUtils.endsWithAny(uri, new String[]{".jsp"}) && !IdsStringUtils.endsWithAny(uri, new String[]{".java"});
    }
