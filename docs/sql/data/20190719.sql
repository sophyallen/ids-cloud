INSERT INTO `gateway_route` (`route_id`, `route_name`, `path`, `service_id`, `url`, `strip_prefix`, `retryable`, `status`, `is_persist`, `route_desc`) VALUES ('1152136796736503810', 'ids-cloud-generator-server', '/code/**', 'ids-cloud-generator-server', '', '0', '0', '1', '0', '在线代码生成服务器');

INSERT INTO `base_menu` (`menu_id`, `parent_id`, `menu_code`, `menu_name`, `menu_desc`, `scheme`, `path`, `icon`, `target`, `priority`, `status`, `create_time`, `update_time`, `is_persist`, `service_id`) VALUES ('1152141296369057794', '1', 'Generate', '在线代码生成', '在线代码生成', '/', 'system/generate/index', 'md-document', '_self', '0', '1', '2019-07-19 17:01:05', '2019-07-19 17:02:00', '0', 'ids-cloud-base-server');
INSERT INTO `base_action` (`action_id`, `action_code`, `action_name`, `action_desc`, `menu_id`, `priority`, `status`, `create_time`, `update_time`, `is_persist`, `service_id`) VALUES ('1152234326254051329', 'GenerateCode', '生成代码', '', '1152141296369057794', '0', '1', '2019-07-19 23:10:46', '2019-07-19 23:10:54', '0', 'ids-cloud-base-server');
