package com.kkb.idscloud.mybatis.entity;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.common.collect.Maps;
import com.kkb.idscloud.common.core.constants.CommonConstants;
import com.kkb.idscloud.common.core.utils.BeanConvertUtils;
...
public class PageParams extends Page implements Serializable {
    ...
    public String getOrderBy() {
        if (IdsStringUtils.isBlank(order)) {
            order = "asc";
        }
        if (IdsStringUtils.isNotBlank(sort)) {
            this.setOrderBy(String.format("%s %s", IdsStringUtils.camelToUnderline(sort), order));
        }
        return orderBy;
    }
