package com.kaikeba.idscloud.common.core.utils;
 ...
 */
public class IdsStringUtils extends StringUtils {
    ...
    public static String stripXss(String value) {
        if (IdsStringUtils.isNotBlank(value)) {
    ...
    public static void main(String[] args) {
        System.out.println(IdsStringUtils.matchDomain("515608851@qq.com"));
        System.out.println(IdsStringUtils.matchDomain("www.qq.com"));
        System.out.println(IdsStringUtils.matchDomain("qq.com"));
        System.out.println(IdsStringUtils.matchIp("qq.com"));
        System.out.println(IdsStringUtils.matchIp("192.168.0.1"));
